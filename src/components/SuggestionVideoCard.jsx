    ...
    <Link to={`/video/${video?.videoId}`}>
      <div className="flex mb-3 ">
        ...
        <div className="flex flex-col ml-3 overflow-hidden">
          ...
          <span className="flex items-center text-white/[0.7]  text-[12px] lg:text-[10px] xl:text-[12px] font-semibold mt-2">
            {video?.author?.title}
          ...
          <div className="flex text-[12px]  lg:text-[10px] xl:text-[12px] font-semibold text-white/[0.7] truncate overflow-hidden ">
            <span>
              {video?.stats?.views !== undefined && !isNaN(video?.stats?.views)
